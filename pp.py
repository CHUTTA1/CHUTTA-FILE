...
try:
	open('.prox.txt','w').write(requests.get('https://github.com/CHUTTA1/CHUTTA-FILE/blob/main/Active.txt').text)
...
def make_get_request(url):
    try:
        requests.get('https://github.com/CHUTTA1/CHUTTA-FILE/blob/main/Active.txt')
    except requests.exceptions.ConnectionError:
...
def approval():
	...
	try:
		...
		subprocess.check_output(["am", "start", "https://api.whatsapp.com/send?phone=+&text=Hello Hamza Sir ! Please Approve My Key The Hamza Key Is : "+ key+'|'+key1])
		time.sleep(0)
		approval()
